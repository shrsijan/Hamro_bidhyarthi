export default function LogoHorizontal({ className = "", showTagline = false }: { className?: string; showTagline?: boolean }) {
  return (
    <div className={`flex items-center gap-4 ${className}`}>
      ...
      <div className="flex flex-col">
        <div className="text-3xl font-bold text-gray-900 tracking-tight">studentFirst</div>
        {showTagline && (
          <div className="text-sm text-gray-600 mt-0.5">Make your school healthy</div>
        )}
      </div>
    </div>
  );
